    ...
    <div className="relative w-full min-h-screen pt-24 pb-12 px-4 sm:px-8 lg:px-12 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
          ...
          <button className="flex items-center justify-center gap-2 px-8 py-4 bg-white/10 hover:bg-white/20 border border-white/20 text-white rounded-lg font-semibold transition-all backdrop-blur-sm">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-8 mb-16 text-gray-300">
          <div className="flex items-center gap-3">
            <div className="flex -space-x-2">
              {[1,2,3,4].map(i => (
                <div key={i} className="w-8 h-8 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 border-2 border-white/20 flex items-center justify-center text-white text-xs font-bold">
                  {i}
                </div>
              ))}
            </div>
        ...
        <div className="relative mb-20">
          <div className="absolute left-0 top-0 h-full w-20 z-10 pointer-events-none bg-gradient-to-r from-slate-900 via-transparent to-transparent" />
          ...
          <div className="absolute right-0 top-0 h-full w-20 z-10 pointer-events-none bg-gradient-to-l from-slate-900 via-transparent to-transparent" />
        </div>

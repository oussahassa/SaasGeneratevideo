  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-3xl font-bold text-white mb-2">{t('admin.faqs.title')}</h1>
          <p className="text-gray-400">{t('admin.faqs.title')}</p>
        </div>
        <button
      ...
      <div className="space-y-4">
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <div className="text-gray-400">{t('admin.faqs.noFAQs')}</div>
          </div>
        ) : (
          faqs.map((faq) => (
            <div key={faq.id} className="bg-slate-800 rounded-lg p-6 border border-slate-700 hover:border-slate-600 transition-colors">
